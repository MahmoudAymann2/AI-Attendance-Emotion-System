...
CSV_DIR  = os.path.abspath(".")            # where CSV files will be written
...
def write_csv(present):
    """Write the session’s attendance list to a fresh CSV file."""
...
def send_email(to_addr: str, subj: str, body: str):
    """Send one plain-text e-mail.  Skips silently if SMTP creds are missing."""
